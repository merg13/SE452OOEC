 ...
 *  
 *  <li><em>JPARepository Tables stored in SQL H2 In-Memory Database</em> - Users, User_Roles, Users_Roles</li>
 *  
 ...
 *  
 *  <li><em>Provides pre-authorization policies</em> based on the UserRoleType enum for use Securing FlixNet API Endpoints. 
 *      Examples: @Secured("ROLE_CUSTOMER", "ROLE_ADMIN")
 *  </li>
 *  
 ...
 *  
 *  <li><em>Entity LOMBO Usage</em>@Data, @NoArgsConstructor, @AllArgsConstructor, @Entity, @Builder, @SuperBuilder</li>
 * </ul>
 * 
 *  
 */
